...
public abstract class SharedFelinidSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<FelinidFoodComponent, FullyEatenEvent>(OnMouseEaten); // HardLight: Merged with upstream; BeforeFullyEatenEvent<FullyEatenEvent
    }

    private void OnMouseEaten(Entity<FelinidFoodComponent> ent, ref FullyEatenEvent args) // HardLight: Merged with upstream; BeforeFullyEatenEvent<FullyEatenEvent
    {
        var user = args.User;
