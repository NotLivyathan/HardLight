...
[ByRefEvent]
public readonly record struct BodyPartAttachedEvent(Entity<OrganComponent> Part);
...
[ByRefEvent]
public readonly record struct BodyPartDroppedEvent(Entity<OrganComponent> Part);

[ByRefEvent]
public readonly record struct BodyPartEnableChangedEvent(bool Enabled);

[ByRefEvent]
public readonly record struct BodyPartEnabledEvent(Entity<OrganComponent> Part);

[ByRefEvent]
public readonly record struct BodyPartDisabledEvent(Entity<OrganComponent> Part);
