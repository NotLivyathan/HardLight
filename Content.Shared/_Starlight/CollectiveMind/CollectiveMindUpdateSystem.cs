// VRS port: Goobstation/Starlight CollectiveMind — runtime helpers for
// adding/removing collective mind channels on entities and assigning the
// per-channel ascending "number" each speaker is identified by.
