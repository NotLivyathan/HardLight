...
public sealed class NukeOpsTest
{
    ...
    /// </summary>
    [Test]
    [Ignore("Not relevant for Frontier, no nuke ops gameplay.")] // Frontier, // HardLight: I'm just going to assume we want to keep this.
    public async Task TryStopNukeOpsFromConstantlyFailing()
    {
        ...
        Assert.That(entMan.Count<StationColcommComponent>(), Is.Zero); // HardLight: StationCentcommComponent<StationColcommComponent
        ...
        Assert.That(entMan.Count<StationColcommComponent>(), Is.EqualTo(1)); // HardLight: StationCentcommComponent<StationColcommComponent
