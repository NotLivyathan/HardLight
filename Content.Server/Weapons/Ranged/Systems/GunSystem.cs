...
using Content.Shared._RMC14.Weapons.Ranged.Prediction; // RMC14
...
public sealed partial class GunSystem : SharedGunSystem
{
    ...
    public override void Initialize()
    {
        ...
        // Frontier start
        SubscribeLocalEvent<AutoShootGunComponent, ActivateInWorldEvent>(OnActivateGun);
        SubscribeLocalEvent<AutoShootGunComponent, ComponentInit>(OnGunInit);
        SubscribeLocalEvent<AutoShootGunComponent, ComponentShutdown>(OnGunShutdown);
        SubscribeLocalEvent<AutoShootGunComponent, ExaminedEvent>(OnGunExamine);
        SubscribeLocalEvent<AutoShootGunComponent, PowerChangedEvent>(OnPowerChange);
        SubscribeLocalEvent<AutoShootGunComponent, AnchorStateChangedEvent>(OnAnchorChange);
        // Frontier end
    }
        ...
        EntityCoordinates fromCoordinates, EntityCoordinates toCoordinates, out bool userImpulse, EntityUid? user = null, bool throwItems = false)
    {
        ...
        {
            // Frontier start: Set projectiles to map parent
            if (ent != null)
