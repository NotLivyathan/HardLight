...
namespace Content.Server.Hands.Systems
{
    public sealed class HandsSystem : SharedHandsSystem
    {
        ...
        {
            TryAddHand(ent.AsNullable(), component, args.Part, args.Slot); // HardLight: Merged with upstream; uid<ent.AsNullable()
        }
        ...
        private void HandleBodyPartEnabled(EntityUid uid, HandsComponent component, ref BodyPartEnabledEvent args) =>
            TryAddHand(ent.AsNullable(), component, args.Part, SharedBodySystem.GetPartSlotContainerId(args.Part.Comp.ParentSlot?.Id ?? string.Empty)); // HardLight: Merged with upstream; uid<ent.AsNullable()
