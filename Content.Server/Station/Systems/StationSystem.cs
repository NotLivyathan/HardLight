...
public sealed partial class StationSystem : SharedStationSystem
{
    ...
    private void OnPostGameMapLoad(PostGameMapLoad ev)
    {
        ...
        // HardLight start: Check for duplicate stations and grids before spawning
        ...
        foreach (var (id, gridIds) in dict)
        {
            ...
            // HardLight start: Check if a station with this name or ID already exists
...
// HardLight: I'm just assuming we did this.
