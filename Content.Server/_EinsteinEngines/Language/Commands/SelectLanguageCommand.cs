...
public sealed class SelectLanguageCommand : IConsoleCommand
{
    ...
    /// <summary>
    ///     Tries to parse the input argument as either a language ID or the position of the language in the list of
    ///     languages the entity can speak. Returns true if successful.
    /// </summary>
