...
namespace Content.Client.Inventory
{
    ...
    public sealed class StrippableBoundUserInterface : BoundUserInterface
    {
        ...
        private void AddHandButton(Entity<HandsComponent> ent, string handId, Hand hand)
        {
            ...
            UpdateEntityIcon(button, EntMan.HasComponent<StripMenuHiddenComponent>(heldEntity) ? _virtualHiddenEntity : heldEntity); // HardLight: Merged with upstream; hand.HeldEntity<heldEntity
            // End Goobstation
